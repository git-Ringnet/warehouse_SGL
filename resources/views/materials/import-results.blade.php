        ...
        <div class="lg:ml-64 flex-1 mt-[4rem]">
            <header class="bg-white shadow-sm border-b border-gray-200 p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Kết quả Import Vật tư</h1>
            ...
            <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
                ...
                <div class="text-xs text-yellow-700 space-y-1">
                    ...
                    <div>Created materials count: {{ count($results['created_materials'] ?? []) }}</div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
                        <div class="p-6 border-b border-gray-200">
                            <h2 class="text-lg font-semibold text-gray-900 flex items-center">
                                ...
                                Vật tư đã tạo thành công ({{ $results['success_count'] }})
                            </h2>
                        </div>
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach ($results['created_materials'] as $material)
                                        <tr>
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
                        <div class="p-6 border-b border-gray-200">
                            <h2 class="text-lg font-semibold text-gray-900 flex items-center">
                                ...
                                Vật tư trùng lặp ({{ $results['duplicate_count'] }})
                            </h2>
                            <p class="text-sm text-gray-600 mt-1">Các vật tư đã tồn tại trong hệ thống (không bao gồm vật tư đã xóa)</p>
                        </div>
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
                        <div class="p-6 border-b border-gray-200">
                            <h2 class="text-lg font-semibold text-gray-900 flex items-center">
                                ...
                                Lỗi khi tạo vật tư ({{ $results['error_count'] }})
                            </h2>
