...
<head>
    ...
    <title>Chi tiết phiếu lắp ráp - WMS</title>
                                                        ...
                                                        <tr class="hover:bg-gray-50">
                                                            ...
                                                            <td class="px-6 py-4 text-sm text-gray-500">
                                                                @php
                                                                    ...
                                                                    if ($materialUnit) {
                                                                        $lengthUnits = ['Mét', 'm', 'meter', 'meters', 'cm', 'Cm', 'centimeter', 'centimeters', 'mm', 'millimeter', 'millimeters', 'km', 'kilometer', 'kilometers', 'inch', 'inches', 'in', 'foot', 'feet', 'ft', 'yard', 'yards', 'yd'];
