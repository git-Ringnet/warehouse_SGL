...
<head>
    ...
    <title>Thêm phần mềm mới - WMS</title>
...
<body>
        ...
        <main class="p-6">
            <div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100 p-6">
                <form action="{{ route('software.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="version" name="version" class="w-full h-10 border border-gray-300 rounded-lg px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" placeholder="VD: 1.0.0" value="{{ old('version') }}">
                            </div>
                        ...
                        <div class="space-y-4">                            
                            <div>
                                ...
                                <input type="text" id="release_date" name="release_date" class="w-full h-10 border border-gray-300 rounded-lg px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white date-input" value="{{ old('release_date') ?? date('d/m/Y') }}" placeholder="dd/mm/yyyy">
                            </div>
                    ...
                    <!-- File upload section -->
                    <div class="mt-6">
                        <h3 class="text-md font-semibold text-gray-800 mb-3">Tải lên file phần mềm (Không bắt buộc)</h3>
                    ...
                    <div class="mt-6">
                        <h3 class="text-md font-semibold text-gray-800 mb-3">Tải lên tài liệu hướng dẫn (Không bắt buộc)</h3>
                        <div class="border-dashed border-2 border-gray-300 rounded-lg p-6 bg-gray-50">
                            <div class="space-y-4">
                                <div class="flex items-center justify-center">
    ...
    <script>
        // Đặt mặc định ngày phát hành nếu trống (dd/mm/yyyy)
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (releaseInput && !releaseInput.value) {
                ...
                releaseInput.value = `${day}/${month}/${year}`;
            }
        });
