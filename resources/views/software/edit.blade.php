...
<head>
    ...
    <title>Chỉnh sửa phần mềm - WMS</title>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-4">                            
                            <div>
                                ...
                                <input type="text" id="release_date" name="release_date" class="w-full h-10 border border-gray-300 rounded-lg px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white date-input" value="{{ old('release_date', $software->release_date ? $software->release_date->format('d/m/Y') : date('d/m/Y')) }}" placeholder="dd/mm/yyyy">
                            </div>
