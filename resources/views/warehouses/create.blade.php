...
<head>
    ...
    <title>Thêm kho hàng mới - WMS</title>
                ...
                <form action="{{ route('warehouses.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                <label for="manager"
                                    class="block text-sm font-medium text-gray-700 mb-1 required">Người quản lý</label>
                                <div class="relative">
                                    ...
                                    <input type="hidden" id="manager" name="manager" required>
                                </div>
                            </div>
                            <div>
                                <label for="address" class="block text-sm font-medium text-gray-700 mb-1">Địa
                                    chỉ</label>
                                <input type="text" id="address" name="address" placeholder="Nhập địa chỉ kho"
                                    value="{{ old('address') }}"
                                    class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            <label for="description" class="block text-sm font-medium text-gray-700 mb-1">Mô tả kho
                                hàng</label>
