    ...
    <div class="content-area">
        <header class="bg-white shadow-sm py-4 px-6 flex justify-between items-center sticky top-0 z-40">
            <div class="flex items-center">
                <a href="{{ asset('warehouses') }}" class="text-gray-600 hover:text-blue-500 mr-4">
            ...
            <div class="bg-white rounded-xl shadow-md p-6 border border-gray-100 mx-auto">
                <form action="#" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" id="code" name="code" placeholder="KHO-XX" required 
                            ...
                            <div>
                                ...
                                <input type="text" id="name" name="name" placeholder="Nhập tên kho" required 
                                    class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            
                            <div>
                                <label for="address" class="block text-sm font-medium text-gray-700 mb-1 required">Địa chỉ <span class="text-red-500">*</span></label>
                                <input type="text" id="address" name="address" placeholder="Nhập địa chỉ kho" required 
                                    class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" id="manager" name="manager" placeholder="Nhập tên người quản lý" required
                                    class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="email" id="email" name="email" placeholder="Nhập email người quản lý"
                                    class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        </div>
                    ...
                    <div class="mt-8 flex justify-end space-x-3">
                        <a href="{{ asset('warehouses') }}" class="bg-gray-200 text-gray-700 px-5 py-2 rounded-lg hover:bg-gray-300 transition-colors">
                            Hủy
                        </a>
