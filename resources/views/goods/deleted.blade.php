...
<head>
    ...
    <title>Hàng hóa đã xóa - SGL</title>
    ...
    <div class="content-area">
        <header
            ...
            <div class="flex items-center gap-4">
                ...
                <h1 class="text-xl font-bold text-gray-800">Hàng hóa đã xóa</h1>
            </div>
        ...
        <main class="p-6">
            ...
            @else
                <div class="bg-white rounded-xl shadow-md p-8 text-center">
                    ...
                    <h3 class="text-xl font-semibold text-gray-700 mb-2">Không có hàng hóa nào đã xóa</h3>
