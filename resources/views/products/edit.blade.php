                            ...
                            <div>
                                ...
                                <div class="flex relative">
                                    <select id="unit" name="unit" required
                                        ...
                                        <option value="Mét" {{ old('unit', $product->unit) == 'Mét' ? 'selected' : '' }}>Mét</option>
                                        <option value="Cuộn" {{ old('unit', $product->unit) == 'Cuộn' ? 'selected' : '' }}>Cuộn</option>
                                    ...
                                    <button type="button" id="clearUnitBtn"
                                        class="absolute right-12 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600 {{ $product->unit ? '' : 'hidden' }} mx-2">
