...
<head>
    ...
    <title>Thành phẩm đã xóa - SGL</title>
    ...
    <div class="content-area">
        <header
            ...
            <div class="flex items-center gap-3">
                ...
                <h1 class="text-xl font-bold text-gray-800">Thành phẩm đã xóa</h1>
            </div>
            <div class="flex gap-2">
                <a href="{{route('products.index')}}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg flex items-center transition-colors">
                    <i class="fas fa-list mr-2"></i> Danh sách chính
                </a>
                <a href="{{route('products.hidden')}}" class="bg-yellow-500 hover:bg-yellow-600 text-white px-4 py-2 rounded-lg flex items-center transition-colors">
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-red-700">
                                Đây là danh sách các thành phẩm đã được đánh dấu là đã xóa nhưng vẫn được lưu để theo dõi lịch sử.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        @if ($products->isEmpty())
                            <tr>
                                <td colspan="8" class="px-6 py-4 text-center text-gray-500 whitespace-nowrap">
                                    Không có thành phẩm đã xóa nào
                                </td>
                            </tr>
                        @endif
                    </tbody>
