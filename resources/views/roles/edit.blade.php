                    ...
                    <div class="mb-4">
                        ...
                        <div class="border border-gray-300 rounded-lg p-4 max-h-80 overflow-y-auto">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                @foreach($employees as $employee)
                                <div class="flex items-start">
                                    <input type="checkbox" name="employees[]" id="employee-{{ $employee->id }}" value="{{ $employee->id }}" 
                    ...
                    <div class="mb-4">
                        ...
                        <div class="border border-gray-300 rounded-lg p-4 max-h-80 overflow-y-auto">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="flex items-start">
                                    <input type="checkbox" name="projects[]" id="project-{{ $project->id }}" value="{{ $project->id }}" 
                                           class="mt-1 h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="border border-gray-300 rounded-lg p-4 max-h-80 overflow-y-auto">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="flex items-start">
                                    <input type="checkbox" name="rentals[]" id="rental-{{ $rental->id }}" value="{{ $rental->id }}" 
                                           class="mt-1 h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
