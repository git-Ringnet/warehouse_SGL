    ...
    <div class="content-area">
        <header class="bg-white shadow-sm py-4 px-6 flex justify-between items-center sticky top-0 z-40">
            ...
            <div class="flex space-x-2">
                <a href="{{ url('/customers/1/edit') }}" class="bg-yellow-500 hover:bg-yellow-600 text-white px-4 py-2 rounded-lg flex items-center transition-colors">
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
                    <div class="p-6">
                        <div class="flex flex-col md:flex-row justify-between">
                            <div>
                                <h2 class="text-2xl font-bold text-gray-800">Nguyễn Văn B</h2>
                                <p class="text-gray-600 mt-1">Khách hàng từ 01/05/2024</p>
                            </div>
                            <div class="mt-4 md:mt-0 flex flex-col items-start md:items-end">
                                <div class="flex items-center">
                                    <i class="fas fa-phone-alt text-gray-400 mr-2"></i>
                                    <span class="text-gray-800 font-medium">0912345678</span>
                                </div>
                                <div class="flex items-center mt-1">
                                    <i class="fas fa-envelope text-gray-400 mr-2"></i>
                                    <span class="text-gray-800">nguyenb@gmail.com</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-6 mb-6">
                    <div>
                        ...
                        <p class="text-gray-900 font-medium">Nguyễn Văn B</p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-500">Số điện thoại</p>
                        <p class="text-gray-900 font-medium">0912345678</p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-500">Email</p>
                        <p class="text-gray-900">nguyenb@gmail.com</p>
                    </div>
                    <div>
                ...
                <div class="border-t border-gray-200 pt-4">
                    ...
                    <p class="text-gray-900 mt-1">Khách hàng thường xuyên, có nhu cầu đặt hàng vào cuối tháng.</p>
                </div>
            </div>
        </main>
    </div>
