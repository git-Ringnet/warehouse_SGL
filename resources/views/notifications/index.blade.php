    ...
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex space-x-2">
                <button id="markAllReadBtn" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-sm">
                    <i class="fas fa-check-double mr-2"></i>Đánh dấu tất cả đã đọc
                </button>
                <button id="refreshBtn" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg text-sm">
