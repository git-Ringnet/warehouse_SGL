...
<body>
    ...
    <div class="content-area">
        <header class="bg-white shadow-sm py-4 px-6 flex justify-between items-center sticky top-0 z-40">
            ...
            <a href="{{ asset('warranties') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded-lg flex items-center transition-colors">
            ...
            <form action="#" method="POST">
                ...
                <div class="bg-white rounded-xl shadow-md p-6 border border-gray-100 mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="activation_code" class="block text-sm font-medium text-gray-700 mb-1">Mã kích hoạt</label>
                            <div class="flex">
                                <input type="text" id="activation_code" name="activation_code" 
                                    class="w-full border border-gray-300 rounded-l-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <p class="text-xs text-gray-500 mt-1">Để trống để tự động tạo mã</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start">
                            ...
                            <div class="ml-3 text-sm">
                                <label for="send_notification" class="font-medium text-gray-700">Gửi thông báo kích hoạt đến khách hàng</label>
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="print_warranty" name="print_warranty" type="checkbox"
                                    class="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300 rounded">
                            </div>
                            <div class="ml-3 text-sm">
                                <label for="print_warranty" class="font-medium text-gray-700">In phiếu bảo hành</label>
                                <p class="text-gray-500">Tạo và in phiếu bảo hành cho khách hàng</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-yellow-50 rounded-xl shadow-md p-6 border border-yellow-200 mb-6">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Bạn đang chuẩn bị kích hoạt bảo hành cho thiết bị này. Hành động này không thể hoàn tác.</p>
                        </div>
                    </div>
                    <div class="mt-4">
                        <div class="flex items-start">
                            ...
                            <div class="ml-3 text-sm">
                                <label for="confirm_activate" class="font-medium text-gray-700 required">Tôi xác nhận rằng thông tin đã được kiểm tra và đồng ý kích hoạt bảo hành <span class="text-red-500">*</span></label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-end space-x-3">
                    <a href="{{ asset('warranties') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded-lg transition-colors">
                        Hủy
                    </a>
                    <button type="submit" class="bg-green-500 hover:bg-green-600 text-white px-6 py-2 rounded-lg transition-colors flex items-center">
