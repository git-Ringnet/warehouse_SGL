...
<head>
    ...
    <title>Danh sách sửa chữa & bảo trì - WMS</title>
    ...
    <div class="content-area">
        @php
            ...
            $canCreate =
                $user &&
                ($user->role === 'admin' ||
                    ($user->role_id && $user->roleGroup && $user->roleGroup->hasPermission('repairs.create')));
            $canViewDetail =
                $user &&
                ($user->role === 'admin' ||
                    ($user->role_id && $user->roleGroup && $user->roleGroup->hasPermission('repairs.view_detail')));
            $canEdit =
                $user &&
                ($user->role === 'admin' ||
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <select name="repair_type"
                            ...
                            <option value="maintenance"
                                {{ request('repair_type') == 'maintenance' ? 'selected' : '' }}>Bảo trì định kỳ
                            </option>
                            <option value="repair" {{ request('repair_type') == 'repair' ? 'selected' : '' }}>Sửa chữa
                                lỗi</option>
                            <option value="replacement"
                                {{ request('repair_type') == 'replacement' ? 'selected' : '' }}>Thay thế linh kiện
                            </option>
                            <option value="upgrade" {{ request('repair_type') == 'upgrade' ? 'selected' : '' }}>Nâng
                                cấp</option>
        ...
        <div class="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <div class="text-center">
                ...
                <p class="text-sm text-gray-500 mb-4">
                    Bạn có chắc chắn muốn xóa phiếu sửa chữa <span id="deleteRepairCode"
