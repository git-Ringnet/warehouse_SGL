...
@section('title', 'Tạo phiếu bảo trì dự án - WMS')
        ...
        <div class="mb-6 border-b border-gray-200 pb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="request_date" id="request_date" required class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 date-input" value="{{ old('request_date', date('d/m/Y')) }}" readonly>
        ...
        <div class="mb-6 border-b border-gray-200 pb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="maintenance_date" id="maintenance_date" required class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 date-input" value="{{ old('maintenance_date', date('d/m/Y')) }}">
                </div>
                <div>
