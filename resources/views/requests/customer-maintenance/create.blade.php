...
<head>
    ...
    <title>Phiếu khách yêu cầu bảo trì - SGL</title>
    ...
    <div class="content-area">
        <header class="bg-white shadow-sm py-4 px-6 flex justify-between items-center sticky top-0 z-40">
            <div class="flex items-center">
                <h1 class="text-xl font-bold text-gray-800">Phiếu khách yêu cầu bảo trì</h1>
        ...
        <main class="p-6">
            <form action="{{ url('/requests/customer-maintenance') }}" method="POST" class="bg-white rounded-xl shadow-md p-6">
                @csrf
                ...
                <div class="mb-6 border-b border-gray-200 pb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="receiver" id="receiver" required class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-6 border-b border-gray-200 pb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="device_name" id="device_name" required class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div>
                            <label for="device_model" class="block text-sm font-medium text-gray-700 mb-1">Model/Serial</label>
                            <input type="text" name="device_model" id="device_model" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div class="md:col-span-2">
                            <label for="issue_description" class="block text-sm font-medium text-gray-700 mb-1 required">Mô tả sự cố</label>
                            <textarea name="issue_description" id="issue_description" rows="3" required class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-6 border-b border-gray-200 pb-4">
                    ...
                    <div class="flex items-center space-x-6">
                        ...
                        <div class="flex items-center">
                            <input type="radio" name="priority" id="priority_medium" value="medium" class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500" checked>
                            <label for="priority_medium" class="ml-2 block text-sm font-medium text-gray-700">Trung bình</label>
                        </div>
                        <div class="flex items-center">
                            <input type="radio" name="priority" id="priority_high" value="high" class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500">
                    ...
                    <div id="material_container">
                        <div class="material-row grid grid-cols-1 md:grid-cols-5 gap-4 mb-3">
                            <div class="md:col-span-3">
                                ...
                                <input type="text" name="material[0][name]" id="material_name_0" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>
                            <div class="md:col-span-1">
                                <label for="material_quantity_0" class="block text-sm font-medium text-gray-700 mb-1">Số lượng</label>
                                <input type="number" name="material[0][quantity]" id="material_quantity_0" min="1" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>
                ...
                <div class="mb-6 border-b border-gray-200 pb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="estimated_hours" id="estimated_hours" min="1" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                    </div>
                </div>
